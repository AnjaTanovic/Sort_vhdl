...
HD_PWD='D:/Anja/FAKULTET/Godina4/Semestar1/Projektovanje_slozenih_digitalnih_sistema/vezbe/v11/ip_sort/SORT/SORT.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SORT_v1_0.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SORT_v1_0.tcl -notrace
