...
HD_PWD='D:/Anja/FAKULTET/Godina4/Semestar1/Projektovanje_slozenih_digitalnih_sistema/vezbe/v11/ip_sort/SORT/SORT.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SORT_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SORT_v1_0.tcl
